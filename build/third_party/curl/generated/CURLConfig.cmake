...
set(CURL_VERSION_STRING "8.21.0-DEV")
set(CURL_LIBRARIES CURL::libcurl)
set(CURL_LIBRARIES_PRIVATE "bcrypt;advapi32;crypt32;secur32;ws2_32;iphlpapi")
set_and_check(CURL_INCLUDE_DIRS "${PACKAGE_PREFIX_DIR}/include")

set(CURL_SUPPORTED_PROTOCOLS "HTTP;HTTPS")
set(CURL_SUPPORTED_FEATURES "alt-svc;AsynchDNS;HSTS;HTTPS-proxy;IPv6;Kerberos;Largefile;SPNEGO;SSL;SSPI;threadsafe;UnixSockets")
