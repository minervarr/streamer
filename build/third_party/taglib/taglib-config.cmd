...
:doit
if /i "%1#" == "--libs#"    echo -LC:/Program Files (x86)/streamer/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/Program Files (x86)/streamer/include -IC:/Program Files (x86)/streamer/include/taglib
if /i "%1#" == "--version#" echo 2.3
if /i "%1#" == "--prefix#"  echo C:/Program Files (x86)/streamer
